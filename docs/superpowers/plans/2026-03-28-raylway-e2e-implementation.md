# Finvoice End-to-End Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Wire the existing Finvoice UI prototype to real deployed smart contracts, real AI credit scoring via OpenRouter, and real blockchain reads/writes — producing a demo-ready hackathon MVP.
...
```bash
cd /Users/fabianferno/Documents/finvoice && pnpm add viem
```
...
```bash
cd /Users/fabianferno/Documents/finvoice
...
contract DeployInvoiceToken is Script {
    function run() external {
        ...
        InvoiceToken token = new InvoiceToken(
            "https://finvoice.app/api/metadata/{id}",
            "Finvoice Invoice",
            endpoint,
            deployer
        );
...
contract DeployPublic is Script {
    function run() external {
        ...
        InvoiceReceipt receipt = new InvoiceReceipt(
            "https://finvoice.app/api/receipt/",
            "Finvoice Receipt",
            "RWRECEIPT",
            publicEndpoint,
            deployer,
    ...
    React.createElement(Page, { size: "A4", style: styles.page },
      ...
      React.createElement(View, { style: styles.header },
        React.createElement(View, {},
          React.createElement(Text, { style: styles.logo }, "finvoice"),
      ...
      React.createElement(View, { style: styles.footer },
        React.createElement(Text, {}, "Generated by Finvoice — Private Invoice Factoring on Flare"),
...
```bash
cd /Users/fabianferno/Documents/finvoice && pnpm build
```
...
```bash
cd /Users/fabianferno/Documents/finvoice && forge build
```
...
```bash
git add -A
git commit -m "feat: complete end-to-end Finvoice implementation - contracts, APIs, AI scoring, frontend wiring"
```
