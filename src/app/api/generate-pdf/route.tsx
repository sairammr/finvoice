...
function InvoicePDF({ invoice }: { invoice: any }) {
  ...
  return (
    <Document title={`Invoice ${invoice.id}`} author="Hedsup" subject="Private Invoice Factoring">
      <Page size="A4" style={s.page}>
        ...
        <View style={s.footer} fixed>
          <Text style={s.footerBrand}>Generated by Hedsup — Private Invoice Factoring on Flare</Text>
...
`;
  pdfDoc.addJavaScript("hedsup", js);
